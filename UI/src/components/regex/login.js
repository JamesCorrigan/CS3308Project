...
var lowerMatch, upperMatch, numberMatch, lengthMatch, pwMatch;
	...
	myInput.onkeyup = function() {
       ...
       /* TODO: Question 1.1: Ends here */
        ...
        console.log(JSON.stringify(letter.classList));
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var pw1 = myInput.value;
                var pw2 = confirmMyInput.value;
                var passEqualsConfPass = (pw1 === pw2) ? true : false; // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
    ...
    /* TODO Question 1.3: Starts here */
    if (lowerMatch == true && upperMatch == true && numberMatch ==true && lengthMatch ==true && pwMatch == true) {
      var conditon = true;
    } else {
      var condition = false;}

                // Disable or Enable the button based on the elements in classList
                enableButton(letter, capital, number, length, match, condition);
    }
}


function enableButton(letter, capital, number, length, match, condition) {
